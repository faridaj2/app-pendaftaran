                    ...
                    <form role="form" action="{{ route($form) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <input type="text" name="nama"
                                ...
                                placeholder="Masukkan Nama" aria-label="Email" aria-describedby="email-addon">
                        </div>
                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700">KK</label>
                        <div class="mb-4">
                            <input type="number" name="kk"
                                class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                placeholder="Masukkan Nomer KK" aria-label="Password" aria-describedby="password-addon">
                        </div>
                        ...
                        <div class="mb-4">
                            <input type="text" name="alamat"
                                class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                placeholder="Masukkan Alamat" aria-label="Password" aria-describedby="password-addon">
                        </div>
                        ...
                        <div class="mb-4">
                            <input type="text" name="ibu"
                                class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                placeholder="Masukkan nama Ibu" aria-label="Password" aria-describedby="password-addon">
                        </div>
